...
public class Practice14GetFontMetricsView extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        float offest = (middle - metrics.descent + metrics.ascent) / 2;

        canvas.drawText(texts[0], 100, middle + offest, paint2);
        canvas.drawText(texts[1], 200, middle + offest, paint2);
        canvas.drawText(texts[2], 300, middle + offest, paint2);
        canvas.drawText(texts[3], 400, middle + offest, paint2);
        canvas.drawText(texts[4], 500, middle + offest, paint2);
        canvas.drawText(texts[5], 600, middle + offest, paint2);
    }
}
